        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/auth.Auth/GetGoogleLoginUrl",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("auth.Auth", "GetGoogleLoginUrl"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/auth.Auth/GetGoogleLoginUrl" => {
                    ...
                    struct GetGoogleLoginUrlSvc<T: Auth>(pub Arc<T>);
                    impl<
                        T: Auth,
                    ...
                    for GetGoogleLoginUrlSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Auth>::get_google_login_url(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
